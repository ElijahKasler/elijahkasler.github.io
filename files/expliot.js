...
(() => {
  ...
  // --- Scott iframe full screen with full width top notch ---
  ...
  function createScottWindow() {
    ...
    applyStyles(scottNotch, {
      ...
      fontSize: '14px',
      textAlign: 'center',
      // Removed border-radius for rectangle
  ...
  // --- Console window (draggable, bottom right) ---
  let consoleDiv = null;
  ...
  // Show/hide toggle menu and fade background with Right Shift key
